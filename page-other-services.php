<?php
/**
 * Template for other services content
 *
 * @package WordPress
			...
			<div id="content" role="main">
				...
				<div class="container">
					...
					<div class="twelve columns">
						<h2>DIY Cupcakes</h2>
						<p>
							We have provide theme inspired for cakes (Barbie cakes, Under the Sea cakes, etc), cupcakes &amp; cookies.
						</p>
						<p>
							WE MAKE, YOU DECORATE!
						</p>
						<p>
						...
						<h2>Magician &amp; Clowns</h2>
						<p>
							We have collaborated with Fiftyonemagic for services such as clown, magic or both.
						</p>
						<p>
						...
						<ul class="ulp" style="padding-left:15px">
							...
							<i>Clown (1½ hours) and Magic (½ hour)</i>
						</ul>
						<p>
							For more information on this promotion, please contact 016-5868521
						</p>
					</div>
				</div>
